...
Public Class InfrmFacturas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "miniERPSoloAprobados.InfrmFacturas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInfrmFacturas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InfrmFacturas = New InfrmFacturas()
        rpt.Site = Me.Site
        Return rpt
    End Function
